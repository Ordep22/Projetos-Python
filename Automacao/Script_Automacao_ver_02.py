...
#Neste etape preciso de um rele para fazer as atualizações
...
##caso o usuário tenha clicado no botão ele irá ficar com uma cor diferente enão o software não irá encontrar!!!PONTO DE ATENÇÃO!!!
...
localiza_and_click(path_Vel_conecxao_19200)
...
##Iniciar o processo de envio e recebimento da base

#Selecionar a aba de envio/recebimento

localiza_and_click(path_Button_Envio_Recebimento)

#Enviar o arquivo de base

localiza_and_click(path_Button_enviar)
py.sleep(118)

#Finalizar processo de envio de base
...
py.press('enter')
py.sleep(1)
    #Essa etapa foi necessária pois o software não estav identificandi o próximo passo
py.moveTo(655,414)
...
py.sleep(70)
    #Neste estap será necessário que o programa aguarde um pouco mais
    #que o previsto, pois o usuário deve avaliar alguns parâmetro.
    #Como alternativa é possível criar um relatório ao final da execução do script
...
#Finalizar o precesso desconectar
